...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_58bba6a6326d2"];
}else{
	jvxObjectList.push("jvx_58bba6a6326d2");
}

	// when document.body is not there, inject document.write which will be default create the html structure
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_58bba6a6326d2' style='display:none;'></div>")
	}
			...
			createImprTrackerFrame = function(frameId){
				...
				function jvx_58bba6a6326d2fireImprTracker(url, elType){
			var elNode = null;
			if(elType == 'script'){
							} else {
...
finalURL = replaceCacheBuster4;				//finalURL = replaceCacheBuster;
			...
			if(elType == 'script'){
														imprScrTrackerCnt++;
					var imprFrameId = 'jvx_58bba6a6326d2ImprTrackerFrame_'+imprScrTrackerCnt;
			...
			function jvx_58bba6a6326d2fireIT(){
										jvx_58bba6a6326d2fireImprTracker('https://ad.doubleclick.net/ddm/trackimp/N3382.668587.AODDISPLAY/B10749616.143719626;dc_trk_aid=315619585;dc_trk_cid=77663187;ord=1488694323;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?', 'img');
																																}
		
		jvx_58bba6a6326d2fireIT();
		
	/*
JavaScript responsible for frame busting
*/
var jvx_58bba6a6326d2TraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_58bba6a6326d2SafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_58bba6a6326d2CanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_58bba6a6326d2InNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_58bba6a6326d2TraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 250);
		jvx_58bba6a6326d2SafeFrameSupported = true;
}catch(e){
	jvx_58bba6a6326d2SafeFrameSupported = false;
}
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_58bba6a6326d2'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_58bba6a6326d2.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_58bba6a6326d2.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_58bba6a6326d2.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_58bba6a6326d2.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_58bba6a6326d2.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_58bba6a6326d2.DwellRecorded){
					jvx_58bba6a6326d2.recordDwellEvent(49, jvx_58bba6a6326d2.DwellElapsedTime);
				}
			}
									else if(msg=="DYReportingKey") {
				jvx_58bba6a6326d2.DYReportingKey = decodeURIComponent(s[2]);
				...
				jvx_58bba6a6326d2.recordEvent(66, 'es_et_' + creativeResolveElapseTime);
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_58bba6a6326d2' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_58bba6a6326d2' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
		...
		var currPageURL = "";
				try {
			if(jvx_58bba6a6326d2TraffickedInFrame){
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_58bba6a6326d2 != 'undefined'){
				finalURL += "&es_cgName_"+jvx_58bba6a6326d2.DYReportingKey;
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_58bba6a6326d2.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_58bba6a6326d2SafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_58bba6a6326d2,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_58bba6a6326d2.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_58bba6a6326d2.baseContainerId)){
				return; 
			}
		jvx_58bba6a6326d2.init();		
		}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","creativeUnitType":"20","bDim":"300x250","bUnitId":"2000","siteId":"6585ced35976de","campaignId":"80602","es_pId":"40Y4Y8","isDynamic":"1","jvxVer":"2","clickInteractionTracker":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=CfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM&num=1&sig=AOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg&client=ca-pub-1993393738408076&dbm_c=AKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha&adurl=","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=CfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM&num=1&sig=AOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg&client=ca-pub-1993393738408076&dbm_c=AKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha&adurl=","r":"1488658735267142","0":"","serverURL":"https:\/\/as.jivox.com"};
		
		this.campaignId = '80602';
		this.siteId = '6585ced35976de';
		this.placementId = '40Y4Y8';
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=6585ced35976de&campaignId=80602&es_pId=40Y4Y8&isDynamic=1&jvxVer=2&clickInteractionTracker=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&r=1488658735267142&objectName=jvx_58bba6a6326d2&adUnitId=2000&jvxSessionId=1488692902.9993';
				this.baseURL += '&base=1';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_58bba6a6326d2SafeFrameSupported){
		         var callBackFnName ='jvx_58bba6a6326d2'+".updateDYReportingKey";
		         jvx_58bba6a6326d2.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYReportingKey: function(val){
         	jvx_58bba6a6326d2.DYReportingKey=JSON.parse(val);
         },     
			...
			if(eventSrc != 'undefined' && eventSrc != null){
                    ...
                    if(jvx_58bba6a6326d2SafeFrameSupported){
                        jvx_58bba6a6326d2.sendCookieRequest('jvx_58bba6a6326d2'+"_DYReportingKey");	
                     }
                											}	
		},
		...
		getBaseFlash:function(){
			...
			obj.params = {'movie' : this.baseURL, 
						  ...
						  'flashvars' : "objectName=jvx_58bba6a6326d2&campaignId=80602&siteId=6585ced35976de&adUnitType=20&es_pId=40Y4Y8&&eventReportingURL=http://evs.jivox.com/jivox/serverAPIs/saveImpression.php&eventId=1000&clickTag=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3Dhttp%253A%252F%252Fwww.rei.com%252F"
						 };
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_58bba6a6326d2SafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_58bba6a6326d2"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
						window.open('https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM&num=1&sig=AOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg&client=ca-pub-1993393738408076&dbm_c=AKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha&adurl=http%3A%2F%2Fwww.rei.com%2F');
				...
				if(!this.raiseCMacroFlag){
					...
					this.recordEvent(1, eventRecordParams);
										...
										fireTracker('https://ad.doubleclick.net/ddm/trackclk/N3382.668587.AODDISPLAY/B10749616.143719626;dc_trk_aid=315619585;dc_trk_cid=77663187;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=');
													},
				openExpansion:function(autoExpand, skipOpenEvent){
			
						
						if(!jvx_58bba6a6326d2CanBustFromFrame || jvx_58bba6a6326d2InNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var esParams = "es_pId_40Y4Y8";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "80602/6585ced35976de/20/jvxSId_1488692902.9993";
				...
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM&num=1&sig=AOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg&client=ca-pub-1993393738408076&dbm_c=AKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha&adurl=http%3A%2F%2Fwww.rei.com%2F") : eventReportingURL;
									eventReportingURL += "/es_cgName_"+jvx_58bba6a6326d2.DYReportingKey;
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
																					document.write('<div id="jvxScrRefNode_58bba6a6326d2" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_58bba6a6326d2");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=6585ced35976de&campaignId=80602&es_pId=40Y4Y8&isDynamic=1&jvxVer=2&clickInteractionTracker=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&r=1488658735267142&objectName=jvx_58bba6a6326d2';
											this.baseURL += '&jvxSessionId=1488692902.9993';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&&siteId=6585ced35976de&campaignId=80602&es_pId=40Y4Y8&isDynamic=1&jvxVer=2&clickInteractionTracker=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCfYQkLyG7WIanEMuemQTnmJ6ACdXtjZ1IytnzlIMFChABII_A7iJgyYaAgISk7A-gAdfr-bkDyAEJqAMBqgSoAU_Q0ocDD6wsRemzFNNH14tiUSbveUjFqgDRPN4Y4d0pZNaQiRq_kSxV2ilr_a5sg8bfJhOamTAUkyBHb4H5Sf5LqfHco_qS2zGuu-HnPdTV7txZk8RVXJ6cWEMNtTWPbQS7lmBDWndGvbGmS-uGI4qC4YqSd8cTRHeVe2-uXnulGzpOMD30V81i-oMJckWAk_LHe-mnSC2hMyg2l1DMl839RyXBPo2jmuAEA6AGTYAHkZSGRqgHpr4b2AcA0ggFCIBhEAHIE6b2-gHQEwDYEwM%26num%3D1%26sig%3DAOD64_0b3LCSjCxaTZAfV9sdrC5mOMsNZg%26client%3Dca-pub-1993393738408076%26dbm_c%3DAKAmf-BG5Yy9c01eijJxDl8oLf8HUPhv3Y-gool6OOA7uKV-87S9vqVPKcU5qDqsnGf_5EAiAzha%26adurl%3D&r=1488658735267142&objectName=jvx_58bba6a6326d2'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1488692902.9993';
		...
		listenerCallback:function(event) {
			jvx_58bba6a6326d2.eventController(event); 
		},
...
var jvx_58bba6a6326d2 = new CreativeUnit("_58bba6a6326d2");
jvx_58bba6a6326d2.DYReportingKey = "";
    jvx_58bba6a6326d2.init();
